...
de_table.toy_ref   <- contrast_each_group_to_the_rest(toy_ref_se,    dataset_name="ref", num_cores = 2)
de_table.toy_query <- contrast_each_group_to_the_rest(toy_query_se,  dataset_name="query", num_cores = 2)
...
de_table.demo_query <- contrast_each_group_to_the_rest(demo_query_se.filtered, "a_demo_query",      num_cores = 2)
```
...
de_table.demo_ref   <- contrast_each_group_to_the_rest(demo_ref_se.filtered,   "a_demo_reference",  num_cores = 2)
```
