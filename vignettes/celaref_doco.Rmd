...
<!-- Group 1 is large, and -->
<!-- while adjacent to group 3 in the tSNE plot, does not have a clear 'front runner'  -->
<!-- for similarity. With the reciprocal match to Th lymphocytes looking at a reciprocal -->
<!-- match could be useful (below). -->

<!-- Two groups have been labelled with 'B cells', though cluster 4 more confidently. -->
