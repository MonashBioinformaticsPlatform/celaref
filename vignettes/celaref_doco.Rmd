...
```{r eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE}
 ...
 #TEMP.
# Preprocessed data
celaref_data_dir <- '/home/sarah.williams/data/projects/cell_groupings/analysis/13_RrunsOnM3/celarefData/celarefData'
de_table.10X_pbmc4k_k7        <- readRDS(file.path(celaref_data_dir, 'de_table_10X_pbmc4k_k7.rds'))
de_table.Watkins2009PBMCs     <- readRDS(file.path(celaref_data_dir, 'de_table_Watkins2009_pbmcs.rds'))
de_table.zeisel.cortex        <-  readRDS(file.path(celaref_data_dir, 'de_table_Zeisel2015_cortex.rds'))
de_table.zeisel.hippo         <-  readRDS(file.path(celaref_data_dir, 'de_table_Zeisel2015_hc.rds'))
de_table.Farmer2017lacrimalP4 <- readRDS(file.path(celaref_data_dir, 'de_table_Farmer2017_lacrimalP4.rds'))
