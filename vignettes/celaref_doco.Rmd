...
** DOCO BEING UPDATED: no more ks tests and median threshold - replaced with wilcox.test to label cell groups (now with stats!) **
...
arbitrary threshold of similarity at 0.25 (dotted line). This is 
